...
class UserEndpointTests {
    ...
    public void testChangeEmail() throws UserNotFoundAppException {
        UserDTO user = given().headers(
                ...
                .when()
                .put("http://localhost:8080/api/users/request_change_email")
                .then()
                .statusCode(200)
                .contentType(JSON)
                .extract()
        ...
        UserDTO userAfterChange = given().headers(
                ...
                .contentType("application/json")
                .when()
                .put("http://localhost:8080/api/users/change_email?token=" + userEntity.getEmailResetToken() + "&email=pbuckichange@example.com")
                .then()
                .statusCode(200)
                .contentType(JSON)
                .extract()
    ...
    public void testResetPassword() throws UserNotFoundAppException {
        UserDTO user = given()
                ...
                .when()
                .put("http://localhost:8080/api/users/request_reset_password")
                .then()
                .statusCode(200)
                .contentType(JSON)
                .extract()
        ...
        UserDTO userAfterChange = given()
                ...
                .when()
                .put("http://localhost:8080/api/users/reset_password?id=-5&token=" + userEntity.getPasswordResetToken())
                .then()
                .statusCode(200)
                .contentType(JSON)
                .extract()
